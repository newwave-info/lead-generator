...
add_action('wp_enqueue_scripts', function () {
    ...
    $style_path  = $theme_dir . '/common/css/azienda.css';
    $script_path = $theme_dir . '/common/js/azienda.js';
    ...
    if (file_exists($style_path)) {
        wp_enqueue_style('lg-azienda', $theme_uri . '/common/css/azienda.css', [], $style_version ?: null);
    }

    if (file_exists($script_path)) {
        wp_enqueue_script('lg-azienda', $theme_uri . '/common/js/azienda.js', [], $script_version ?: null, true);
    }
}, 20);
