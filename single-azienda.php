                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="badge"><?php echo $growth_stage
                                                ? esc_html($growth_stage)
                                                : "-"; ?></div>
                                        </div>
                                        <div class="col-6">
                                            <div class="small text-muted">Budget Marketing stimato</div>
                                            <div class="badge"><?php echo $estimated_marketing_budget
                                                ? esc_html(
                                                    $estimated_marketing_budget
                                                )
                                                : "-"; ?></div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="badge"><?php echo $confidence !==
                                            ""
                                                ? esc_html($confidence)
                                                : "-"; ?></div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="small text-muted">Motivazioni qualifica</div>
                                            <div><?php echo $motivazioni_status !==
                                            ""
                                                ? esc_html($motivazioni_status)
                                                : "-"; ?></div>
                                        </div>
                                ...
                                <div>
                                    <div class="d-grid gap-2">
                                        ...
                                        <?php if ($website): ?>
                                            <a class="btn btn-dark" href="<?php echo esc_url(
                                                $website
                                            ); ?>" target="_blank" rel="noopener">Visita sito</a>
                                        <?php endif; ?>
                            ...
                            <div class="table-responsive">
                                <table id="companyAgents" class="stripe cell-border hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php foreach (
                                                ...
                                                <th data-bs-toggle="tooltip" title="<?php echo esc_attr(
                                                    $metric["label"]
                                                ); ?>">
                                    ...
                                    <tbody>
                                        <?php foreach (
                                            $agents
                                            as $slug => $agent_config
                                        ):

                                            $analysis_info =
                                                $analisi_for_company[$slug] ??
                                                null;
                                            $has_analysis =
                                                $analysis_info !== null;
                                            $analysis_id =
                                                $analysis_info["id"] ?? null;
                                            $last_run_display =
                                                $analysis_info["last_run"][
                                                    "display"
                                                ] ?? "";
                                            $last_run_relative =
                                                $analysis_info["last_run"][
                                            ...
                                            $score_value = $has_analysis
                                                ? psip_theme_normalize_scalar(
                                                    get_field(
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#analysis-tabs" class="analysis-name"><span class="dashicons <?php echo esc_attr(
                                                    $agent_config["icon"]
                                                ); ?>"></span> <?php echo esc_html(
    $agent_config["name"]
); ?></a>
                                            </td>
                                            <td class="agent-score" style="background-color:<?php echo $bg_color; ?>" data-bs-toggle="tooltip" title="Quality score"><?php echo $score_numeric !==
null
    ? esc_html((string) $score_numeric)
    : ""; ?></td>
                                            ...
                                            <?php foreach (
                                                ...
                                                $display_value =
                                                    $value !== ""
                                                        ...
                                                        : "";
                                                ?>
                                                <td data-bs-toggle="tooltip" title="<?php echo esc_attr(
                                                    $agent_config["name"] .
                                                        ": " .
                                                        $metric["label"]
                                                ); ?>" class="agent-score" style="background-color:<?php echo $bg_color; ?>"><?php echo $display_value; ?></td>
                                            <?php
                                            endforeach; ?>

                                            <td title="<?php echo $last_run_relative
                                                ? esc_attr($last_run_relative)
                                                : ""; ?>">
                                                <?php echo $last_run_display !==
                                                ""
                                                    ? esc_html(
                                                        $last_run_display
                                                    )
